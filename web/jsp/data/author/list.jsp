...
<head>
    ...
    <title>作者 - 数据库 - BangumiNote</title>
</head>
<body>
...
<script>
    $(function () {
        ...
        var rest = restful.newlist({url: "/api/content/authors"}).appendparams(requestparams);
        build_list($("#api-panel")).info({
            title: "作者",
            createUrl: "/web/data/authors/create",
            content: [
                {header: "ID", field: "uid", sortable: true, link: function (i) {return "/web/data/authors/info/" + i.id}},
                {header: "名字", field: "name", sortable: true, link: function (i) {return "/web/data/authors/info/" + i.id}},
