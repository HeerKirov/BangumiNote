...
class H2 : BodyElement("h1")
class H3 : BodyElement("h1")
class H4 : BodyElement("h1")
class H5 : BodyElement("h1")
class H6 : BodyElement("h1")
...
fun BodyElement.h1(init: (H1.() -> Unit)?=null) = doInit(H1(), init)
fun BodyElement.h2(init: (H2.() -> Unit)?=null) = doInit(H2(), init)
fun BodyElement.h3(init: (H3.() -> Unit)?=null) = doInit(H3(), init)
fun BodyElement.h4(init: (H4.() -> Unit)?=null) = doInit(H4(), init)
fun BodyElement.h5(init: (H5.() -> Unit)?=null) = doInit(H5(), init)
fun BodyElement.h6(init: (H6.() -> Unit)?=null) = doInit(H6(), init)
fun BodyElement.p(init: (P.() -> Unit)?) = doInit(P(), init)
fun BodyElement.a(href: String="#", onclick: String?=null, clazz: String?=null, dataToggle: String?=null, init: (A.() -> Unit)?=null) = doInit(A(), init).set("href" to href, "onclick" to onclick, "class" to clazz, "data-toggle" to dataToggle)
fun BodyElement.a_(href: String="#", onclick: String?=null, clazz: String?=null, dataToggle: String?=null, init: (A.() -> String)?=null) = doInit2(A(), init).set("href" to href, "onclick" to onclick, "class" to clazz, "data-toggle" to dataToggle)
...
fun BodyElement.button(id: String?=null, type: String="button", clazz: String?=null, dataToggle: String?=null, dataTarget: String?=null, onclick: String?=null, init: (Button.() -> Unit)?=null)
        = doInit(Button(), init).set("id" to id, "type" to type, "class" to clazz, "data-toggle" to dataToggle, "data-target" to dataTarget, "onclick" to onclick)
fun BodyElement.button_(id: String?=null, type: String="button", clazz: String?=null, dataToggle: String?=null, dataTarget: String?=null, onclick: String?=null, init: (Button.() -> String)?=null)
        = doInit2(Button(), init).set("id" to id, "type" to type, "class" to clazz, "data-toggle" to dataToggle, "data-target" to dataTarget, "onclick" to onclick)
