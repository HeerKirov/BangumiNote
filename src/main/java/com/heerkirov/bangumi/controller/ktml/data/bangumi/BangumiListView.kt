    ...
    impl("SCRIPT", text("""
        ...
        build_list(${'$'}("#api-panel")).info({
            ...
            visibleGroup: [
                ...
                {name: "观影信息", items: ["uid", "name", "finished_time", "watching", "multiple_time", "seen_the_original"]},
            ...
            content: [
                ...
                {header: "发布时间", field: "publish_time", sortable: true, type: "datetime", typeInfo: {format: "yyyy-mm"}},

                {header: "看完时间", field: "finished_time", sortable: true, type: "datetime", typeInfo: {format: "yyyy-mm-dd"}},
                {header: "观看中", field: "watching", sortable: true, type: "bool"},
                {header: "二刷", field: "multiple_time", sortable: true, type: "bool"},
                {header: "看过原作", field: "seen_the_original", sortable: true, type: "bool"},
