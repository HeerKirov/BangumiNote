    ...
    impl("SCRIPT", text("""
        ...
        build_detail(${'$'}("#api-panel")).info({
            ...
            content: [
                ...
                {header: "观看中", field: "watching", type: "text", typeInfo: {allowNull: false}},
                {header: "二刷", field: "multiple_time", type: "text", typeInfo: {allowNull: false}},
                {header: "看过原作", field: "seen_the_original", type: "text", typeInfo: {allowNull: false}},
                "collapse:主观评价",
